...
import {GET_ALL_USER_MOODS_ACTION, GET_PROFILE_USER_ACTION, ADD_NEW_MOOD_ACTION} from '../../redux/actions/userActions'
...
const Profile = ({
  ...
  const renderMoodList = () => {
    return (<MoodList id={id} moods={moods} owner={profileUser} currentUser={currentUser}/>)
  }
...
const mapStateToProps = state => {
  return {currentUser: state.authReducer.currentUser, loggedIn: state.authReducer.loggedIn, profileUser: state.userReducer.profileUser, moods: state.userReducer.moods, userError: state.userReducer.errors}
}
